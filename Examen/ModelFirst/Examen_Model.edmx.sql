...
-- --------------------------------------------------
-- Date Created: 02/03/2026 18:48:29
-- Generated from EDMX file: C:\Users\Sergienko\source\repos\Coursework_Network_Programming\Examen\ModelFirst\Examen_Model.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_productsimages]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[productsSet] DROP CONSTRAINT [FK_productsimages];
GO
IF OBJECT_ID(N'[dbo].[FK_usersimages]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[usersSet] DROP CONSTRAINT [FK_usersimages];
GO
IF OBJECT_ID(N'[dbo].[FK_adminsimages]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[adminsSet] DROP CONSTRAINT [FK_adminsimages];
GO
